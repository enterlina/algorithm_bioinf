...
loop = 3
for i in range ( max_length - loop - 2 , -1 , - 1 ):
    for j in range ( i + loop + 1 , max_length ):
        diag = 0
        if complementary ( Genome_1[ i ] , Genome_2[ j ] ) == 'true':
            diag = M[ i + 1 ][ j - 1 ] + 1
        ...
        # print ( "ij" , i , j , "   Mij" , M[ i ][ j ] , "   top" , top ,
        #         "   left" ,left , "   diag" , diag , "   Mi + 1/ j - 1  " , M[ i + 1 ][ j - 1 ] , "   Gen_1" ,
